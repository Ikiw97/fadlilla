...
const nomor_hp_yang_ngirim = "+6281287819147"
const nama_yang_ngirim = "lelakimu ini"

// nama 
const nama = "Nurfadilla Meilani Putri"
...
const kata = [
  `Cepet sehat ya cantiku, semangat ${nama}, ❤️`,
  `Jaga kesehatan yaaa sayangku🙃`,
  `Selalu tersenyum, apapun yang orang lakuin ke kita ya ${nama}`,
  `Jangan lupa makan ya, pokonya jangan telat makan`,
  `I LOVE YOU SAYANGKU ${nama} cantik 🙌✨`
]
